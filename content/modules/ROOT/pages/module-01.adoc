...
If you are presented with a screen stating `No data science projects yet` , its your first time here and we will need to create a new project for you, select the image:_images/intro-create-data-science-project.png[Create data science project]. Name this project `{user}-city`. If you want to add creativity, do so in the description!

Create a new OpenShift AI Workbench by click image:_images/100002010000009100000021A1D82C0B6349F1C3.png[the Create Workbench button]. Name this workbench `{user}-workbench` . If you want to add creativity, do so in the description! This will help you to stay consistent with the rest of the lab.
...
Once `running`, you should be able to access your OpenShift AI Workbench by clicking on the image:_images/100002010000004200000023E46306A5CE3ADC98.png
[open] link to open your new OpenShift AI Workbench.

If presented with an authorization request, you will need to authorize yourself access to your workbench. Click  image:_images/[ the Log in with OpenShift ] button to proceed.
